...
import sys
import time
from connectMQTT import mqtt_connect_hivemq_cloud
...
mqtt = mqtt_connect_hivemq_cloud()
if mqtt is None:#geen verbinding broker, verlaat prog
    print("geen connectie met de broker, bye ...")
    sys.exit()
...
while True:
    ...
    mqtt.publish(f"home/{DEV_NAME}/state",json.dumps(payload).encode())
